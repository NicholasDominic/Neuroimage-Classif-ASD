...
callbacks = [
    ModelCheckpoint(filepath="ckpt/checkpoint-augment-l1-l2-inceptionresnetv2-mask-{epoch:02d}-{val_acc:.3f}.h5", monitor="val_acc", save_best_only=True, mode="max"),
    TerminateOnNaN()
]
...
mask_InceptionResNetV2_model.save("model/augment_l1_l2_mask_InceptionResNetV2_model.h5")
mask_InceptionResNetV2_model.save_weights("model/augment_l1_l2_mask_InceptionResNetV2_weights.h5")
df.from_dict(mask_InceptionResNetV2_model_result.history).to_csv('result/augment_l1_l2_mask_InceptionResNetV2_model_result.csv', index=False)