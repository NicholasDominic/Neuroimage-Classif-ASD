...
callbacks = [
    ModelCheckpoint(filepath="ckpt/checkpoint-augment-l2-inceptionresnetv2-epi-{epoch:02d}-{val_acc:.3f}.h5", monitor="val_acc", save_best_only=True, mode="max"),
    TerminateOnNaN()
]
...
epi_InceptionResNetV2_model.save("model/augment_l2_epi_InceptionResNetV2_model.h5")
epi_InceptionResNetV2_model.save_weights("model/augment_l2_epi_InceptionResNetV2_weights.h5")
df.from_dict(epi_InceptionResNetV2_model_result.history).to_csv('result/augment_l2_epi_InceptionResNetV2_model_result.csv', index=False)